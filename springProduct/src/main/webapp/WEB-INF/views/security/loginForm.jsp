...
<body>
	...
	<div class="container">
		<!-- form 시작 action속성의 값은 /login으로 정해져 있음
			...
			<div class="row">
				<div class="bd-example">
					<c:if test="${error != null}">
						<div class="bd-example">
							<input type="text" class="form-control is-invalid" placeholder="${error}" value="${error}" readonly="true" />
						</div>
					</c:if>
					<c:if test="${logout != null}">
						<div class="bd-example">
							<input type="text" class="form-control is-invalid" placeholder="${logout}" value="${logout}" readonly="true" />
						</div>
					</c:if>
					<div class="mb-3">
